...
const supabaseUrl = (import.meta as any).env?.VITE_SUPABASE_URL || 'https://fxbnrosyxfotvyemflwb.supabase.co';
const supabaseAnonKey = (import.meta as any).env?.VITE_SUPABASE_ANON_KEY || 'sb_publishable_LBGF2V6SdF9Zw6l1OXeixA_LtBd1tBS';
